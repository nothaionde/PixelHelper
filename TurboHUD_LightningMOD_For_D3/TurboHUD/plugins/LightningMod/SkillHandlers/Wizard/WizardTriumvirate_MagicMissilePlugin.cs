...
{
    public class WizardTriumvirate_MagicMissilePlugin : AbstractSkillHandler, ISkillHandler
    {
        public WizardTriumvirate_MagicMissilePlugin()
        ...
        {
            base.Load(hud);
            AssignedSnoPower = Hud.Sno.SnoPowers.Wizard_MagicMissile;
            CreateCastRule()
