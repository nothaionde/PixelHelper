...
{
    public class WizardTriumvirate_ShockPulsePlugin : AbstractSkillHandler, ISkillHandler
    {
        public WizardTriumvirate_ShockPulsePlugin()
        ...
        {
            base.Load(hud);
            AssignedSnoPower = Hud.Sno.SnoPowers.Wizard_ShockPulse;
            CreateCastRule()
