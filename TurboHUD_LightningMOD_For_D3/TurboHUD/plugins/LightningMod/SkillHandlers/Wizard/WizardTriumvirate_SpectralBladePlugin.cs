...
{
    public class WizardTriumvirate_SpectralBladePlugin : AbstractSkillHandler, ISkillHandler
    {
        public WizardTriumvirate_SpectralBladePlugin()
        ...
        {
            base.Load(hud);
            AssignedSnoPower = Hud.Sno.SnoPowers.Wizard_SpectralBlade;
            CreateCastRule()
