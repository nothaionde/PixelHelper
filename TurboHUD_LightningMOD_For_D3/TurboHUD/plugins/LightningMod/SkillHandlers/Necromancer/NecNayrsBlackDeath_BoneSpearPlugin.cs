...
{
    public class NecNayrsBlackDeath_BoneSpearPlugin : AbstractSkillHandler, ISkillHandler
    {

        public NecNayrsBlackDeath_BoneSpearPlugin()
        ...
        {
            base.Load(hud);
            AssignedSnoPower = Hud.Sno.SnoPowers.Necromancer_BoneSpear;
            CreateCastRule()
