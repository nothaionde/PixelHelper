    ...
    public class CrusaderCondemnPlugin : AbstractSkillHandler, ISkillHandler
	{
        ...
        public override void Load(IController hud)
        {
            ...
            CreateCastRule()
                ...
                .IfPrimaryResourceIsEnough(ctx => (ctx.Hud.Game.Me.Powers.CurrentSkills.Any(s => s.SnoPower.Sno == ctx.Hud.Sno.SnoPowers.Crusader_Phalanx.Sno && s.Rune == 3) && ctx.Hud.Game.Me.Powers.BuffIsActive(ctx.Hud.Sno.SnoPowers.UnrelentingPhalanx.Sno)) ? 50 : 0, ctx => ctx.Hud.Game.Me.Powers.BuffIsActive(ctx.Hud.Sno.SnoPowers.FrydehrsWrath.Sno) ? 40 : 0).ThenContinueElseNoCast()//当装备或萃取不懈方阵+且技能栏有斗阵-铁血人墙符文时保留50能量，否则0
