    ...
    public class MonkMysticAllyPlugin : AbstractSkillHandler, ISkillHandler
	{
        ...
        public override void Load(IController hud)
        {
            ...
            CreateCastRule()
                ...
                .IfTrue(ctx => (ctx.Skill.Rune == 3 || (ctx.Skill.Rune == 1 && ctx.Skill.Player.GetSetItemCount(742942) >= 6)) && ctx.Skill.Player.Stats.ResourceCurPri < 50).ThenCastElseContinue()//风相幻身3或水幻身时殷娜6件套且内力低于50
