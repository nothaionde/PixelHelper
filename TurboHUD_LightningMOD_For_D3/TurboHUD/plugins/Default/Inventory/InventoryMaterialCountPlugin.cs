namespace Turbo.Plugins.Default
{
    public class InventoryMaterialCountPlugin : BasePlugin, IInGameTopPainter
    {
        ...
        private ISnoItem[] _materialItems, _legendaryMaterials, _otherStuff, _otherStuff2;
        ...
        public override void Load(IController hud)
        {
            ...
            _otherStuff2 = new ISnoItem[] { Hud.Inventory.GetSnoItem(1102953247), Hud.Inventory.GetSnoItem(2029265596), Hud.Inventory.GetSnoItem(2670343450), Hud.Inventory.GetSnoItem(3336787100), Hud.Inventory.GetSnoItem(198281388)};
        ...
        private long GetItemCount(ISnoItem snoItem)
        {
            switch (snoItem.Sno)
            {
                ...
                case 198281388:
                    return Hud.Game.Me.Materials.PrimordialAshes;
            }
