...
namespace Turbo.Plugins.Default
{
    public class DebugPlugin : BasePlugin, IInGameTopPainter
    {
        ...
        public IBrush CursorToWorldBrush { get; set; }
        ...
        public override void Load(IController hud)
        {
            ...
            CursorToWorldBrush = Hud.Render.CreateBrush(64, 128, 255, 128, 0.3f);
        }
        ...
        public void PaintTopInGame(ClipState clipState)
        {
            ...
            var cursorWorldCoord = Hud.Window.CreateScreenCoordinate(Hud.Window.CursorX, Hud.Window.CursorY).ToWorldCoordinate();
            CursorToWorldBrush.DrawWorldEllipse(3, -1, cursorWorldCoord);
