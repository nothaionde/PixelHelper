// Punkk - https://discord.gg/c2H6T96nd8
namespace Turbo.Plugins.LM
{
    using Turbo.Plugins.Default;
    public class CloseGRVictoryScreenPlugin1 : BasePlugin, IAfterCollectHandler, IInGameTopPainter
    {
        public IFont InfoFont { get; private set; }
        protected IUiElement uiGRVictoryScreen;
        ...
        public CloseGRVictoryScreenPlugin1()
        {
            Enabled = true;
        }
        public override void Load(IController hud)
        {
            ...
            uiGRVictoryScreen = Hud.Render.RegisterUiElement("Root.NormalLayer.GreaterRifts_VictoryScreen.LayoutRoot.Primary_Frame", null, null);   // GRVictoryScreen
        ...
        public void AfterCollect()
        {
            ...
            if (uiGRVictoryScreen?.Visible == true)
            {
        ...
        public void PaintTopInGame(ClipState clipState)
        {
            ...
            if (uiGRVictoryScreen?.Visible == true)
            {
                ...
                InfoFont.DrawText(layout, uiGRVictoryScreen.Rectangle.Left, uiGRVictoryScreen.Rectangle.Top);
            }
