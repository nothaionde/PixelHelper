...
{
    public class RunningTest1 : AbstractSkillTest1
    {
    ...
    {
        public static RunningTest1 IfRunning(this AbstractSkillTest1 parent, bool skill = false)
        {
            var test = new RunningTest1()
            {
