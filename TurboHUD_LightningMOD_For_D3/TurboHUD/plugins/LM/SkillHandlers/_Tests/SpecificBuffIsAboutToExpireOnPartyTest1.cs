...
{
    public class SpecificBuffIsAboutToExpireOnPartyTest1 : AbstractSkillTest1
    {
    ...
    {
        public static SpecificBuffIsAboutToExpireOnPartyTest1 IfSpecificBuffIsAboutToExpireOnParty(this AbstractSkillTest1 parent, ISnoPower snoPower, int iconIndex, int min, int max, HeroClass heroClass, double range)
        {
            var test = new SpecificBuffIsAboutToExpireOnPartyTest1()
            {
                SnoPower = snoPower,
                Min = min,
                Max = max,
