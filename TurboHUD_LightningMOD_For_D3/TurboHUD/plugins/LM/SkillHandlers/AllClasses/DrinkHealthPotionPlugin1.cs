namespace Turbo.Plugins.LM
{
    ...
    public class DrinkHealthPotionPlugin1 : AbstractSkillHandler1, ISkillHandler
    {
        public int SDT { get; set; }
        public int HC { get; set; }
        public int InDanger { get; set; }
        public DrinkHealthPotionPlugin1()
        ...
        private bool IsPotionOnCoolDown(TestContext1 ctx)
        {
            bool IsOnCooldown;
            double Cooldown;
