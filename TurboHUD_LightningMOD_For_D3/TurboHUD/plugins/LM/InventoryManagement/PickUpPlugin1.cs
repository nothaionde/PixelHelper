namespace Turbo.Plugins.LM
{
    ...
    public class PickUpPlugin1 : BasePlugin, IKeyEventHandler, IInGameTopPainter, IAfterCollectHandler, INewAreaHandler
    {
        public bool PickGem { get; set; } = false;
        public bool PickCraft { get; set; } = false;
        public bool PickLegend { get; set; } = false;
        public bool PickAncient { get; set; } = false;
        public bool PickPrimal { get; set; } = false;
        public bool PickWhite { get; set; } = false;
        public bool PickBlue { get; set; } = false;
        public bool PickYellow { get; set; } = false;
        ...
        public void PaintTopInGame(ClipState clipState)
        {
            ...
            {
                str_Info = "нажмите " + ToggleKeyEvent.ToString() + "чтобы поднять";
                str_Running = "нажмите " + ToggleKeyEvent.ToString() + "чтобы остановить";
            }
